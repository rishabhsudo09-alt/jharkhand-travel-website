...
const footerLinks = {
  Destinations: [
    { name: "Europe", href: "/explore?region=europe" },
    { name: "Asia", href: "/explore?region=asia" },
    { name: "Americas", href: "/explore?region=americas" },
    { name: "Africa", href: "/explore?region=africa" },
  ],
  Travel: [
      ...
      <div className="border-t border-white/10">
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-white/60 text-sm">© 2024 Wanderlust. All rights reserved.</div>
